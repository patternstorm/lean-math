...
--
-- Since (Set U).Particular = CongruentUnaryPredicate U, we can directly apply sub_universal.
...
example (S : (Set U).Particular) (Q : CongruentUnaryPredicate U) :
